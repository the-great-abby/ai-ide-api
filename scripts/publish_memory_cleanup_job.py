...
def parse_args():
    parser = argparse.ArgumentParser(description="Publish a memory cleanup job to RabbitMQ")
    parser.add_argument("--dry-run", action="store_true", help="Preview changes without deleting")
    parser.add_argument("--age-days", type=int, default=180, help="Age threshold for staleness")
