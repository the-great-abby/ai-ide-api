...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_namespace_permissions_allowed_project_id"),
        "namespace_permissions",
        ["allowed_project_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_namespace_permissions_namespace"),
        "namespace_permissions",
        ["namespace"],
        unique=False,
    )
    op.create_index(
        op.f("ix_namespace_permissions_project_id"),
        "namespace_permissions",
        ["project_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "allowed_namespaces", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_api_access_tokens_project_id"),
        "api_access_tokens",
        ["project_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_api_access_tokens_token"), "api_access_tokens", ["token"], unique=True
    )
    # --- Other core tables ---
    op.create_table(
        "api_error_logs",
    ...
    op.create_index(
        op.f("ix_enhancements_scope_id"), "enhancements", ["scope_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_feedback_submitted_by"), "feedback", ["submitted_by"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_rule_proposals_id"), "rule_proposals", ["id"], unique=False
    )
    op.create_table(
        "rule_versions",
        sa.Column("id", sa.String(), primary_key=True),
    ...
    op.create_index(
        op.f("ix_rule_versions_scope_id"), "rule_versions", ["scope_id"], unique=False
    )
    op.create_index(
        op.f("ix_rule_versions_scope_level"),
        "rule_versions",
        ["scope_level"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_rules_scope_level"), "rules", ["scope_level"], unique=False
    )
    op.create_index(
