...
def upgrade() -> None:
    ...
    if "feedback" not in inspector.get_table_names():
        ...
        op.create_index(
            op.f("ix_feedback_project"), "feedback", ["project"], unique=False
        )
        op.create_index(
            op.f("ix_feedback_rule_id"), "feedback", ["rule_id"], unique=False
        )
        op.create_index(
    ...
    if "proposals" not in inspector.get_table_names():
        ...
        op.create_index(
            op.f("ix_proposals_submitted_by"),
            "proposals",
            ["submitted_by"],
            unique=False,
        )
    if "rule_versions" not in inspector.get_table_names():
        ...
        op.create_index(
            op.f("ix_rule_versions_id"), "rule_versions", ["id"], unique=False
        )
        op.create_index(
    ...
    if "rules" not in inspector.get_table_names():
        ...
        op.create_index(
            op.f("ix_rules_rule_type"), "rules", ["rule_type"], unique=False
        )
        op.create_index(
