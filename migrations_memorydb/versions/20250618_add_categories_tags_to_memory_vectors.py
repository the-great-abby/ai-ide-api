...
def upgrade():
    op.add_column('memory_vectors', sa.Column('categories', postgresql.JSONB(astext_type=sa.Text()), nullable=True, server_default='[]'))
    op.add_column('memory_vectors', sa.Column('tags', postgresql.JSONB(astext_type=sa.Text()), nullable=True, server_default='[]'))
